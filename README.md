...
<p>Foodboot is a Web Platform combined with Applications running on Cloud. Its main purpose is to work as an assistive tool for nutritionists and clients.
  Nutritionists can manage and control clients' data, view important information about each client (food preferences, medical records etc), use tools such as BMI calculator,
  Water Intake Calculator, Calendar and create personalized Meal Plans for clients using a <strong>Desktop App</strong>. A <strong>Mobile App</strong> is created for the client
  that fetches all the meal plan information in an organised manner. The Web Platform is orchestrated by two web applications (Nutritionist, Client). Each application is composed
  of three main components. A cloud-operating <strong>MySQL</strong> database hosted in Heroku, the <strong>Frontend</strong> written mostly in ReactJS and the
  <strong>Backend</strong> where RESTful API architecture was used for the platform's logic and web services written in NodeJS. As a starting template for the Frontend,
  the CoreUI admin panel is used. For Authentication and user info, the platform integrates Auth0 (SaaS service). The whole project is hosted on GitHub in three different
  repositories and deployed on Netlify (links can be found below).</p>

<h4>GitHub</h4>
<a href="https://github.com/AGEORGIOU4/foodboot-nutritionist">https://github.com/AGEORGIOU4/foodboot-nutritionist</a>
<br/>
<a href="https://github.com/AGEORGIOU4/foodboot-client">https://github.com/AGEORGIOU4/foodboot-client</a>
</br>
<a href="https://github.com/AGEORGIOU4/foodboot-backend">https://github.com/AGEORGIOU4/foodboot-backend</a>

<h4>Domains</h4>
<a href="https://foodboot-nutritionist.netlify.app">https://foodboot-nutritionist.netlify.app</a>
<br/>
<a href="https://foodboot-client.netlify.app">https://foodboot-client.netlify.app</a>
</br>
<a href="https://foodboot-backend.herokuapp.com">https://foodboot-backend.herokuapp.com</a>

<h4>Diagrams:</h4>
  <a href='https://viewer.diagrams.net/?tags=%7B%7D&highlight=0000ff&edit=_blank&layers=1&nav=1&title=Applications%20Diagram.drawio.png#R5VjJcuM2EP0aHa3iIkrU0Vo8VpXHUUZKJTm5IBIiMQYJBgS15OvTEAFx1TJexp5KuUwBD2hiea8bDXbscbT7wlESfmU%2Bph3L8Hcde9KxrMHQhqcE9jnQGxo5EHDi55BZAAvyL1ag7pYRH6eVjoIxKkhSBT0Wx9gTFQxxzrbVbmtGq6MmKMANYOEh2kT%2FJL4Ic9S1BgV%2Bj0kQ6pHN%2FjBviZDurFaShshn2xJkTzv2mDMm8lK0G2Mq907vS253d6L1ODGOY3GNASLr1LgZGO7iO7tbhsH%2BAd%2FfqLdsEM3Ugh%2F%2FWH6bLWe%2FPc4WywU03c7nav5irzclfcbCk6szOvaIZYKSGI%2BPBEgw4MgnMLExo4wDFrMYbEdrVkAdy3Z6zqjfAzwVnD3jemdCaamzOxiawz7gPkpD7KuBNpgLAnQ9oBWmc5YSQVgMbSsmBItKHW4pCWSDYAmgSNU8mCOGAUahiCjUTTVJJUTT0nW1eDkkSpN8oWuyk%2FMYAbOJbIx2gfSBLtqmvS5MPoNlITmfJ5Dwcz5wwogccbqBgdPDgA0aNScwcbwrQYrWL5hFWPA9dNGt2qf2tfq2UKxpKCwsqXWoHUU5SXB8daEjKCgp%2FYCsBg1ZcZwmLE5xQ0vYB39TVUW83k%2Fl01IAI86y2D%2ByzrgIWcBi4J3JbT3w9h0LsVfEoUywKqt4R8RfylyW%2F5blruWo6mRXapvsVYVKVY2Q9xwcxtdq9PEaZVQobdyhiFBpcY%2FpBkux1URk1pRfmOPYv5VBSi6WojQlXsMZQPmmO%2B6NpZuc1ErKMu7hM4RYKnQiHmBxOR5IUs4qj2MKyt5Ug%2BSby8htkdE%2FGU7Fx6uoO3DKQjqrImCL76XVjdE17L5GcgX2bUcDhfWhVjGfY05gU2Ws%2Bn8q0%2FlUytTpSUma36aLZcfqH3ZvxaEUyNLtfPZxYtW6MyqSuyC3X0VZFxVjv7VilOlcHuHF6WsPqqdvT2tDvyJ3AWVV091xGi%2BXotVQoiQPdhnABeaQRjQESKJD1lvWioImJApgFpSs4OlRkjwhLmSRRUkG0SeFcv7SpyXbwtO03B38d5M4eINMpr6XttnMZNyWRMY1TrP2Oj9vJsifJpPR5csH0K%2Fi0hcPi5%2Fk0j3ngkvnsefdXNpuHi44YgIkZ3zdL35%2FgN8JEmiFWlT4Ot%2FWr31nv%2B613FB%2Bql87jR0eP8ymjydvvC%2B8ZpZIOF7%2FjfoVNncU%2FXXBbLtQxj5nxO8mIYQVq823PEP%2BnfOt68lyjNp1cuB0nQZd%2FRa6TOu9%2BOpffxNoi0UlHqrh93SQOpE8qbz%2FTP708oTFujK6lVhwWljQ2CuD4NH59FlsXJfXNBMkx6m8qOHV7xxNh5%2FvCP9kB%2FJR62ZV6x8v9dce5MMT%2BeQPa7gWEy3X7Lq9vunY6vlGioZq8UU47158Vren%2FwE%3D'>Applications & Server Diagram</a>
    <br/>
...
<h4>Testing</h4>
<p>In the DOCUMENTATION/Testing folder you can find:</p>
<li>A postman script with all the endpoints that can be tested</li>
<li>A postman script with a Push notification request. When running the Client app, a switch notifications toggler generates a token that authorizes firebase push notifications.
  Add this token in the 'to' field of the request body, and send the message. The response will be either on the console (if the app is running on the foreground) or pop-alert
  (if the app is running in the background)</li>

<h4>Pages</h4>
<h5>Nutritionist Web Platform <small> => (Run on Desktop Device)</small></h5>
<p>
  <ul>
    <li>/dashboard</li>
    <li>/profile</li>
...
<h5>Client Web Platform <small> => (Run on Mobile Device)</small></h5>
<p>
<ul>
  <li>/dashboard</li>
</ul>
...
<h4>Features of Nutritionist App</h4>
<p>
  <h6>Authentication</h6>
  <ul>
    <li>Easy on-boarding using a SaaS service</li>
    <li>Third-party social connection (Google)</li>
    <li>Branding Customization</li>
    <li>API Application to retrieve users data from Auth0</li>
  </ul>
  ...
  <ul>
    ...
    <li>Invite client to <strong>Client's App</strong> using button on clients table</li>
    ...
    <li>Print Client's 'View Client Card'</li>
  </ul>
  ...
  <ul>
    ...
    <li>Update Food Combinations per day in 'Update Meal Plan'</li>
    ...
    <li>Filter Food Combinations and choices by type of meal and day</li>
    <li>Zoom in / Zoom out / Strech screen on View Meal Plan</li>
  </ul>
</p>

<h4>Features of Client App</h4>
<p>
  <h6>Authentication</h6>
  <ul>
  ...
  <h6>Meal Plan</h6>
  <ul>
    <li>View Personalized Today's Meal Plan as table</li>
    <li>Filter Food Combinations and choices by and day</li>
  </ul>

  <h6>Push Notifications</h6>
  <ul>
    <li>Integrates firebase and enables push notifications <small>This feature has not been implemented fully</small></li>
  </ul>
</p>
...
<p>
  ...
  <h6>Food Combinations</h6>
    <ol>
      ...
      <li>GET    /meal-plans/food-combinations/:id/:day</li>
