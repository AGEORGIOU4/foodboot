...
import { SwalBottomToast, SwalBottomToast2 } from "src/components/SweetAlerts/Swal";
  ...
  if (isAuthenticated) {
    ...
    return (
      <CRow>
        <CCol>
          <CCard>
            <CCardBody style={{ display: (isLoading) ? "none" : "block" }}>
            ...
            <CCardBody style={{ textAlign: 'center', display: (isLoading) ? "block" : "none" }}>
